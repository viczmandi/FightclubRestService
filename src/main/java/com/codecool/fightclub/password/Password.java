package com.codecool.fightclub.password;
...
public class Password {
	...
	// System.out.println();
	// System.out.println("Verifying that hash and stored hash both match for
	// the test password...");
	// System.out.println();
	//
	// String compare_test = checkPassword(test_passwd, test_hash) ? "Passwords
